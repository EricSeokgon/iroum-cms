...
| v0.6 | 2026-05-13 | MoAI orchestrator | IT 검증 완료 — AuthFlowIT.java + UserMapperIT.java + OrganizationMapperIT.java + PasswordHistoryMapperIT.java GREEN (REQ-AUTH-001~018). Implemented → Tested. |
...
- **구현 범위**: REQ-AUTH-001~018 풀스택 구현 — 4단계 RBAC, JWT, 비밀번호 정책, 본인인증(이메일 OTP), 비밀번호 재설정, 권한 변경 이력, 회원정보 접근 로그
- **테스트**: 신규/수정 119+ tests GREEN (RBAC 32, REQ-AUTH-013 UI 12, REQ-AUTH-016 23, REQ-AUTH-017 29, REQ-AUTH-018 23)
- **참조 커밋**: 1113b71 (REQ-AUTH-018 PIA), ad9f280 (REQ-AUTH-017 본인인증), 73ad7b3 (REQ-AUTH-016 권한 이력), 6c64f9b (REQ-AUTH-013 UI), 0a362dd (REQ-AUTH-013 RBAC)
- **특이사항**: SYSADMIN alias 정책(v0.3.2), DEPT_ADMIN 범위 제한(Q-24) 추가됨. UserMapper organization_id 컬럼 추가(56e3f9d) — SPEC-CMS-009 연계 수정.
