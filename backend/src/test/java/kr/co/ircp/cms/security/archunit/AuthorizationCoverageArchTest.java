...
class AuthorizationCoverageArchTest {
    ...
    @Test
    @DisplayName("AC-AAD-001-1: 운영 @PreAuthorize 메소드 카운트 baseline 회귀 검증 (현재 156, 메소드 레벨만)")
    void operational_preAuthorize_baselineCount() {
        ...
        // (SPEC-CMS-POINTS-001 — 139→146, +7. PointPolicyController 2개(getPolicy=POINTS:READ,
        ...
        // (SPEC-CMS-NOTI-EXT-001 — 146→156, +10. NotificationTemplateAdminController 6개
        ...
        assertThat(count)
                .as("운영 @PreAuthorize 메소드 레벨 카운트가 baseline(156)과 다릅니다 (실제: %d). " +
