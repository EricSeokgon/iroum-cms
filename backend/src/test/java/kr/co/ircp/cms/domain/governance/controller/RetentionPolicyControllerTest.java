...
class RetentionPolicyControllerTest {
    ...
    // (AUTHZ-MATRIX-001 AC-AM-002-11/12와 검증 레이어 분리: 슬라이스 vs IT)
    // ──────────────────────────────────────────────────────────────

    @Test
    @DisplayName("AC-COV-001-1 — GET /retention-policies 인증 없이 접근 시 403 Forbidden (@WebMvcTest 한계)")
    ...
    @DisplayName("AC-COV-001-2 — GET /retention-policies 권한 부족 시 403 Forbidden")
