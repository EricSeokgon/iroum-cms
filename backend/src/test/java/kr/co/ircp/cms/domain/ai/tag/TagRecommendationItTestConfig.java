 ...
 * {@code @Async("aiLogExecutor")} 태그 추천/피드백 로그 적재가 호출 스레드에서 즉시 완료되도록 한다
 * (AC-AI-TAG-011/012 결정적 검증). AI-003 RagItTestConfig 패턴 준용.
 */
// @MX:NOTE: [AUTO] AI-004 IT 결정적 검증 인프라 — MockMlServiceClient @Primary + aiLogExecutor 동기화
// @MX:SPEC: SPEC-CMS-AI-004
@TestConfiguration
@Profile("integration")
public class TagRecommendationItTestConfig {
