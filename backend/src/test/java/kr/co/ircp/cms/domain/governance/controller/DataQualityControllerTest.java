...
class DataQualityControllerTest {
    ...
    @Test
    @DisplayName("AC-COV-001-1 — GET /quality-rules 인증 없이 접근 시 403 Forbidden (@WebMvcTest 한계)")
    void listRules_returns403_withoutAuthentication() throws Exception {
    ...
    @DisplayName("AC-COV-001-2 — GET /quality-rules 권한 부족 시 403 Forbidden")
    void listRules_returns403_withInsufficientAuthority() throws Exception {
