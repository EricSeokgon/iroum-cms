...
class MigrationOrderIT extends AbstractIntegrationTest {
    ...
    // @MX:NOTE: [AUTO] V1~V45 마이그레이션 총 44개 (V11 없음) — 신규 마이그레이션 추가 시 기대값 갱신 필요
    // V43 (bbs_post_scheduled_publish), V44 (qna_hidden_constraint_fix),
    // V45 (ai_simulation_session_extend, SPEC-CMS-SIM-001) 추가로 44개.
