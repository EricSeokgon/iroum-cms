...
class MigrationOrderIT extends AbstractIntegrationTest {
    ...
    // @MX:NOTE: [AUTO] V1~V54 마이그레이션 총 53개 (V11 없음) — 신규 마이그레이션 추가 시 기대값 갱신 필요
    ...
    // V54 (bbs_post_optimistic_lock, SPEC-CMS-CONTENT-REVISION-001 M1) 추가로 53개.
    private static final int EXPECTED_MIGRATION_COUNT = 53;
