...
class MigrationOrderIT extends AbstractIntegrationTest {
    ...
    // @MX:NOTE: [AUTO] V1~V59 마이그레이션 총 58개 (V11 없음) — 신규 마이그레이션 추가 시 기대값 갱신 필요
    ...
    // V59 (user_registration_approval — 가입 승인 게이트, SPEC-CMS-USER-APPROVAL-001 T0) 추가로 58개.
    private static final int EXPECTED_MIGRATION_COUNT = 58;
