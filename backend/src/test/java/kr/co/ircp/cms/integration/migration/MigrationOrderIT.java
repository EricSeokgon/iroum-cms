...
class MigrationOrderIT extends AbstractIntegrationTest {
    ...
    // @MX:NOTE: [AUTO] V1~V60 마이그레이션 총 59개 (V11 없음) — 신규 마이그레이션 추가 시 기대값 갱신 필요
    ...
    // V55 (ai_tag_recommendation, SPEC-CMS-AI-004),
    // V56 (email_template, SPEC-CMS-EMAIL-TEMPLATE-001), V57 (email_template_send_log),
    // V58 (email_template_seed — 권한 + 기본 템플릿 시드, SPEC-CMS-EMAIL-TEMPLATE-001 T10),
    // V59 (user_registration_approval — 가입 승인 게이트, SPEC-CMS-USER-APPROVAL-001 T0),
    // V60 (points_system — 참여 포인트 지급 시스템, SPEC-CMS-POINTS-001) 추가로 59개.
    private static final int EXPECTED_MIGRATION_COUNT = 59;
